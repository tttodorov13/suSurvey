...
$objPHPExcel->getProperties()->setCreator("SU Survey")
        ...
        ->setTitle("SU Survey - Question Gender report")
        ->setSubject("SU Survey - Question Gender report")
        ->setDescription("SU Survey - Question Gender report")
        ->setKeywords("Sofia University,Survey,System,Results")
        ->setCategory("Question Gender Report");

// set sheet id
$sheetId = 0;
$objPHPExcel->setActiveSheetIndex($sheetId)->mergeCells('A1:N1');
$objPHPExcel->setActiveSheetIndex($sheetId)
        ->setCellValue('A1', "Vote Males");
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle("QuestionReportGenderMale");
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle("QuestionReportGenderFemale");
